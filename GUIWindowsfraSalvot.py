...
chattext = ScrolledText(padx=15, pady=15,font=("Times", 12), width=37, wrap="word", state="disabled")
chattext.pack()

entrytext = tk.Entry(font=("Times", 12), bd=4)
entrytext.pack(side="left")

teachbutt = tk.Button(text="Teach", font=("Times", 12), relief="raised", command=teach, state="disabled")
teachbutt.pack(side="right")

sendbutt = tk.Button(text=" Send ", font=("Times", 12), relief="raised", command=sendtext)
sendbutt.pack(side="right")

#Image
fraSalvot1 = tk.PhotoImage(file = "image.gif")
fraSalvot = fraSalvot1.subsample(2, 2)
